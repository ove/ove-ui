/* jshint ignore:start */
// JSHint cannot deal with React.import React, { Component } from 'react';
                ...
                <form id="Form" className="form-horizontal">
                  ...
                  <div className="form-group hoc-alert col-md-12 form-block-holder">
                    <label className="col-md-12 control-label">
                      <h4>As shown in this example, you can also use <a href="https://github.com/jurassix/react-validation-mixin" target="_blank" rel="noopener noreferrer" >react-validation-mixin</a> to handle your validations as well! (as of v4.3.2)!</h4>
                    </label>
                    <br />
